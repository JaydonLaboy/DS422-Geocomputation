...
## 🏥 Introduction: What Makes Communities Healthy?
...
```{r}
#| label: top4-dependence
#| fig-cap: "SHAP feature dependence plots for the next 4 most important variables"
...
:::
They seem to be linear but some have curves.
------------------------------------------------------------------------
