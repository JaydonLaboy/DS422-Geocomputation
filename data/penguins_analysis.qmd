...
ggplot(penguins_data_from_csv, aes(x = culmen_depth_mm, fill = species)) +
  ...
  scale_fill_viridis_d() +
  labs(
    title = "Distribution of Penguin Culmen Depth",
...
```{r}
ggplot(penguins_data_from_csv, aes(x = culmen_depth_mm, 
                                   y = body_mass_g, 
                                   color = species)) +
  ...
  labs(
    title = "Relationship Between Culmen Depth and Body Mass",
    subtitle = "Grouped by Penguin Species",
    x = "Culmen Depth (mm)",
    y = "Body Mass (g)",
    color = "Species"
  )
